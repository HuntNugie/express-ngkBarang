    ...
    <div class="w-full max-w-sm bg-zinc-950 border border-yellow-700/40 rounded-2xl shadow-[0_0_30px_-10px_rgba(234,179,8,0.4)] p-8 backdrop-blur-sm">
      ...
      <form class="space-y-6">
        <div>
          ...
          <input type="text" class="w-full px-4 py-2 bg-zinc-900 border border-yellow-700/30 rounded-lg text-zinc-200 placeholder-zinc-500 focus:ring-2 focus:ring-yellow-500 focus:border-transparent outline-none transition" placeholder="Masukkan username">
        </div>
        <div>
      ...
      <div class="mt-6 text-center">
        <p class="text-sm text-zinc-400">
          Belum punya akun?
          <a href="#" class="text-yellow-400 font-medium hover:text-yellow-300 transition underline underline-offset-2">Daftar Sekarang</a>
        </p>
      </div>
